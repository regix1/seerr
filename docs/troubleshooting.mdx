...
If your admin account no longer has admin privileges, this is typically because your Jellyfin or Emby user ID has changed on the server side.

This can happen if you have a new installation of Jellyfin or Emby, or if you have changed the user ID of your admin account.
